...
def make_decision_tree_params_grid_big(my_args):
    ...
    tree_params = {
        ...
        "model__max_depth": [ 1, 2, 3, 4, None ],
        "model__min_samples_split": [ 0.04, 0.08, 0.16, 0.32 ],
        "model__min_samples_leaf":  [ 0.02, 0.04, 0.1 ],
        "model__max_features":  [ "sqrt", "log2", None ],
        "model__max_leaf_nodes": [  16, 32, 64, None ],
        "model__min_impurity_decrease": [ 0.01, 0.02],
    }
    params.update(tree_params)
    return params
...
def sklearn_metric(y, yhat):
    ...
    print(table)
    print()
    precision = sklearn.metrics.precision_score(y, yhat,average='micro')
    recall = sklearn.metrics.recall_score(y, yhat,average='micro')
    f1 = sklearn.metrics.f1_score(y, yhat, average='micro')
